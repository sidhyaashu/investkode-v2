      ...
      <div className="relative">
        ...
        {open ? (
          <>
            ...
            />
            <div
              className="fixed z-[70] w-[210px] overflow-hidden rounded-[12px] border border-[var(--ik-glass-border)] bg-white/95 p-1.5 shadow-[0_16px_40px_-16px_rgba(43,69,112,0.40)] backdrop-blur-xl dark:bg-[#1A1A1D]/95 dark:shadow-[0_16px_40px_-16px_rgba(0,0,0,0.75)]"
              style={{
                top: coords.top,
                left: coords.left,
              }}
